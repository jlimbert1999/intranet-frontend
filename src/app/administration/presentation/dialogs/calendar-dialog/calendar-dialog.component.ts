...
constructor() {
 ...
 if (startDate && startDate instanceof Date) {
  ...
  if (this.maxDateEnd && endControl?.value && new Date(endControl.value).getTime() > this.maxDateEnd.getTime()) {
 ...
 const allDayCtrl = this.eventForm.get('allDay'); 
 ...
 if (freq === 'YEARLY') {
  ...
  allDayCtrl?.setValue(true, { emitEvent: false });
  allDayCtrl?.disable({ emitEvent: false });
  ...
  allDayCtrl?.enable({ emitEvent: false }); 
 ...
 allDayCtrl?.updateValueAndValidity();
