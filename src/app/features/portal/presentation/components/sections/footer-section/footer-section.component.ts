...
@Component({
  ...
  imports: [],
  template: `
    <footer class="bg-primary-950 text-gray-100 pt-12 pb-6">
      <div
      ...
      >
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li>
              <a href="/" class="hover:text-primary-300 transition">Sitio Web</a>
            </li>
            <li>
              <a href="/transparencia" class="hover:text-primary-300 transition"
                >Transparencia</a
              >
            </li>
            <li>
              <a href="/comunicados" class="hover:text-primary-300 transition"
                >Comunicados</a
              >
            </li>
            <li>
              <a href="/directorio" class="hover:text-primary-300 transition"
        ...
        <div class="lg:col-span-2">
          ...
          <ul class="space-y-2 text-sm text-gray-300">
            <li class="flex items-center">
              <i class="pi pi-map-marker text-primary-300 mr-2"></i>
              GAM-SACABA, CONSISTORIAL S-002, BOLIVIA
            </li>
            <li class="flex items-center">
              <i class="pi pi-phone text-primary-300 mr-2"></i>
              +(591) 4-4701677
            </li>
            <li class="flex items-center">
              <i class="pi pi-envelope text-primary-300 mr-2"></i>
              info@sacaba.gob.bo
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div class="flex space-x-3">
            <a
              ...
              target="_blank"
              class="w-10 h-10 flex items-center justify-center rounded-full bg-primary-800 hover:bg-primary-700 transition"
            >
      ...
      <div
        class="mt-10 px-2 border-t border-primary-800 pt-4 text-center text-sm text-white"
      >
